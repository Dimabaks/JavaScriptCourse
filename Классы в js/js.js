...
document.querySelector(".btn").addEventListener('click', function() {
    for (let i = 0; i < 3; i++) {
        new Card(
            ...
            28500, 
            "Старая коллекция", 
            "Лучший телевизор на свете", 
            ".cards"
        ).render();
    }
})

/* let copyOfCard = new Card("img/tv-2.png", "tv", 18800, 28500, "Старая коллекция", "Лучший телевизор на свете", ".cards"
)
...
class Car {
    ...
    info() {
            console.log(`Машина: ${this.brand}, год ${this.year}`)
    }
}

const myCar = new Car('Opel', '2020');
