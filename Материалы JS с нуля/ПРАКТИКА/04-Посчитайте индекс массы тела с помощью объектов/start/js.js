...
function BMI() {
    this.bmiRes = this.ves / this.rost ** 2
    return this.bmiRes;
}
...
if (Petr.BMI() > Denis.BMI()) {
    console.log(`Индекс массы тела Петра ${Petr.BMI()}, больше индекса массы тела Дениса ${Denis.BMI()}`)
} else if (Denis.BMI() > Petr.BMI()) {
    console.log(`Индекс массы тела Дениса ${Denis.BMI()}, больше индекса массы тела Петра ${Petr.BMI()}`)
} else {
    console.log("Индексы равны")
}
