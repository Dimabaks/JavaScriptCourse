...
/* function getCountryData(country) {
    ...
    //Функция которая использует данные с сервера для использования HTML кода и рендер карточки на странице
    ...
    request.addEventListener("load", function() {
        ...
        // Создаем запрос к серверу внутри первой callback функции
