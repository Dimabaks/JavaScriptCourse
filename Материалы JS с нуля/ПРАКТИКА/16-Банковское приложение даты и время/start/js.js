...
const account1 = {
  ...
  pin: 1111,
  movementsDates: [
    "2025-08-12T21:31:17.178Z",
    "2025-08-13T07:42:02.383Z",
    "2025-08-19T09:15:04.904Z",
    "2025-08-20T10:17:24.185Z",
    "2025-08-23T14:11:59.604Z",
...
function displayMovements(acc, sort = false) {
  ...
  movs.forEach(function (value, i) {
    ...
    <div class="movements__row">
          ...
          <div class="movements__value">${formatCurrency(value, acc.locale, acc.currency)}</div>
        </div>
    `;
...
// Создание логина из ФИО в обьекте
...
function calcDisplaySum(movements) {
  ...
  labelSumIn.textContent = incomes + " Р";

  const out = movements
    .filter((mov) => mov < 0)
    .reduce((acc, mov) => acc + mov, 0)
  labelSumOut.textContent = Math.abs(out) + " Р";

  labelSumInterest.textContent = incomes + out + " Р";
}

// Функция для выозва всех функций
...
console.log(accMov);
const allMov = accMov.flat().reduce(function(acc, val) {
  return acc + val
});
console.log(allMov);
 */
